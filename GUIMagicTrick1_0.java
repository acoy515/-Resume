...
public class GUIMagicTrick implements ActionListener, Runnable{
	...
	public void actionPerformed(ActionEvent e){		
			if(guess>0){
				...
				one.setText(Integer.toString(cards.get(0))+"       "+
						Integer.toString(cards.get(1))+"       "+
						Integer.toString(cards.get(2))+"       "+
						Integer.toString(cards.get(3)));
				two.setText(Integer.toString(cards.get(4))+"       "+
						Integer.toString(cards.get(5))+"       "+
						Integer.toString(cards.get(6))+"       "+
						Integer.toString(cards.get(7)));
				three.setText(Integer.toString(cards.get(8))+"       "+
						Integer.toString(cards.get(9))+"       "+
						Integer.toString(cards.get(10))+"       "+
						Integer.toString(cards.get(11)));
				four .setText(Integer.toString(cards.get(12))+"       "+
						Integer.toString(cards.get(13))+"       "+
						Integer.toString(cards.get(14))+"       "+
						Integer.toString(cards.get(15)));
				return;
